...
namespace backend.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "AvatarUrl", "Email", "IsModerator", "Name", "Password", "SubscriptionActiveUntil", "SubscriptionId", "Wallet" },
                values: new object[,]
                {
                    { 8L, "", "h@mail.com", true, "User H", "hhh", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 0m },
                    { 9L, "aa", "pA@mail.com", false, "Publisher A", "aaa", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 6.78m },
                    { 10L, "bb", "pB@mail.com", false, "Publisher B", "bbb", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 4.50m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 8L, "The Da Vinci Code by Dan Brown * 1; Angels & Demons by Dan Brown * 1;", 8L, 8L });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "", "a@mail.com", false, "User A", "aaa", new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1L, 0.00m },
                    { 2L, "", "b@mail.com", false, "User B", "bbb", new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2L, 3.59m },
                    { 3L, "", "c@mail.com", false, "User C", "ccc", new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 3L, 10.00m },
                    { 4L, "", "d@mail.com", false, "User D", "ddd", new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 4L, 5.32m },
                    { 5L, "", "e@mail.com", false, "User E", "eee", new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 5L, 1.99m },
                    { 6L, "", "f@mail.com", false, "User F", "fff", new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 6L, 7.25m },
                    { 7L, "", "g@mail.com", false, "User G", "ggg", new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1L, 0.50m }
                });
            ...
            migrationBuilder.InsertData(
                table: "Request",
                columns: new[] { "Id", "BookId", "PublisherId", "RequestType" },
                values: new object[,]
                {
                    { 1L, 1L, 9L, 1 },
                    { 2L, 2L, 9L, 1 },
